...
Dialog.addString("Channel 2 name", "Ecad");
Dialog.addString("Channel 3 name", "Col4");
Dialog.addString("Channel 4 name", "organelle");
...
//	c2min = 100; c2max = 1500; idC2_8bit = to8bitMinMax( idC2, typePrefix + "-" + c2name, c2min, c2max, outputFolder, outputPrefix );
	saturation = 0.5; idC3_8bit = to8bitSatu( idC3, typePrefix + "-" + c3name, saturation, outputFolder, outputPrefix );
//	c3min = 50; c3max = 1400; idC3_8bit = to8bitMinMax( idC3, typePrefix + "-" + c3name, c3min, c3max, outputFolder, outputPrefix );
...
//	BGM = mergeBGM( idC1_8bit, c1name, idC2_8bit, c2name, idC4_8bit, c4name, outputFolder, outputPrefix + "-" + typePrefix );

	GM = mergeGM( idC2_8bit, c2name, idC4_8bit, c4name, outputFolder, outputPrefix + "-" + typePrefix );

	GM = mergeGM( idC1_8bit, c1name, idC4_8bit, c4name, outputFolder, outputPrefix + "-" + typePrefix );
	
//	CGMY = mergeCGMY( idC1_8bit, c1name, idC2_8bit, c2name, idC4_8bit, c4name, idC3_8bit, c3name, outputFolder, outputPrefix + "-" + typePrefix );
//
//	BGMY = mergeBGMY( idC1_8bit, c1name, idC2_8bit, c2name, idC4_8bit, c4name, idC3_8bit, c3name, outputFolder, outputPrefix + "-" + typePrefix );
